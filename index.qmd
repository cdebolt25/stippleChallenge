...
# Ensure variables from previous chunks are available
try:
    samples
    img_resized
except NameError:
    raise NameError("samples and img_resized not found. Make sure generate-stipple and prep-image chunks ran successfully.")
...
# Ensure frames and point_counts are available (from progressive-stippling chunk)
try:
    frames
    point_counts
except NameError:
    raise NameError("frames and point_counts not found. Make sure progressive-stippling chunk ran successfully.")
