...
# Note: Image is imported from PIL above, so we can use it to save the stippled image
img_path = 'florida_beach_picture.jpg'
original_img = Image.open(img_path)
if original_img.mode != 'L':
    original_img = original_img.convert('L')
...
stipple_img = Image.fromarray((stipple_pattern * 255).astype(np.uint8))
stipple_img.save('stippled_image.png')
print("Saved stippled image to: stippled_image.png")
```
...
![Original Florida beach image before stippling.](florida_beach_picture.jpg)
